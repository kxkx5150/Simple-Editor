...
****************************************/
simpleEditor.ACE_EDITOR_CUSTOM_KEYS = function(ACE,SimpleEditor,secallback){
    ...
    var keys = [
        {
            ...
            exec: function(editor) {
                if(editor.searchBox)editor.searchBox.findNext();
            },
            readOnly: true
        },
        {
    ...
    var lang = LANG;
    var config = CONFIG;
    if(secallback)secallback(keys);
};
setTimeout(function(){
    simpleEditor.callbackDefaultKeys();
},100)
