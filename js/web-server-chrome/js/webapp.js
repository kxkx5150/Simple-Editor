(function(){
    ...
    WebApplication.prototype = {
        ...
        stop: function() {
            ...
            this.stopped = true;
            setTimeout(function(){
                sockets.tcp.disconnect(that.sockInfo.socketId)
            },0);
            setTimeout(function(){
                sockets.tcpServer.disconnect(that.sockInfo.socketId)
            },10);
        },
        close: function(callback) {
            sockets.tcpServer.close(this.sockInfo.socketId,function() {
